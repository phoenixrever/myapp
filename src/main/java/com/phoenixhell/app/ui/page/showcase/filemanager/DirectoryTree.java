...
import static com.phoenixhell.app.ui.page.showcase.filemanager.Utils.isFileHidden;
...
final class DirectoryTree extends TreeView<File> {
    ...
    public DirectoryTree(com.phoenixhell.app.ui.page.showcase.filemanager.Model model, File rootPath) {
        super();
        ...
        setCellFactory(c -> new TreeCell<>() {
            ...
            protected void updateItem(File item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    var image = new ImageView(com.phoenixhell.app.ui.page.showcase.filemanager.FileIconRepository.FOLDER);
                    image.setFitWidth(20);
                    image.setFitHeight(20);
                    setGraphic(image);

                    pseudoClassStateChanged(com.phoenixhell.app.ui.page.showcase.filemanager.Model.HIDDEN, isFileHidden(item.toPath()));
                }
            }
        });
