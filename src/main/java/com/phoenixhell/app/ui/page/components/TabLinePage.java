...
public final class TabLinePage extends OutlinePage {
    ...
    private ExampleBox closingPolicyExample() {
        ...
        allTabsPolicy.setOnAction(e -> tabLine.setTabClosingPolicy(Tab.ClosingPolicy.ALL_TABS));

        var selectedTabsPolicy = new MenuItem("Selected");
        selectedTabsPolicy.setOnAction(e -> tabLine.setTabClosingPolicy(Tab.ClosingPolicy.SELECTED_TAB));

        var noTabsPolicy = new MenuItem("None");
        noTabsPolicy.setOnAction(e -> tabLine.setTabClosingPolicy(Tab.ClosingPolicy.NO_TABS));
    ...
    private ExampleBox resizePolicyExample() {
        ...
        fixedTabsPolicy.setOnAction(e -> tabLine.setTabResizePolicy(Tab.ResizePolicy.FIXED_WIDTH));

        var computedTabsPolicy = new MenuItem("Computed");
        computedTabsPolicy.setOnAction(e -> tabLine.setTabResizePolicy(Tab.ResizePolicy.COMPUTED_WIDTH));

        var adaptiveTabsPolicy = new MenuItem("Adaptive");
        adaptiveTabsPolicy.setOnAction(e -> tabLine.setTabResizePolicy(Tab.ResizePolicy.ADAPTIVE));

        var stretchTabsPolicy = new MenuItem("Stretch");
        stretchTabsPolicy.setOnAction(e -> tabLine.setTabResizePolicy(Tab.ResizePolicy.STRETCH));
