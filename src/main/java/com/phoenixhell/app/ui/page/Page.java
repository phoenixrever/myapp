package com.phoenixhell.app.ui.page;
...
import com.phoenixhell.app.event.PageEvent;
...
public interface Page {
    ...
    String JFX_JAVADOC_URI_TEMPLATE = "https://openjfx.io/javadoc/20/javafx.controls/javafx/scene/%s.html";
    String AFX_JAVADOC_URI_TEMPLATE = "https://mkpaz.github.io/atlantafx/apidocs/atlantafx.base/atlantafx/base/%s.html";
            ...
            node.addEventFilter(ActionEvent.ACTION, e -> {
                if (e.getTarget() instanceof Hyperlink link && link.getUserData() instanceof String url) {
                    ...
                    if (url.startsWith("local://")) {
                        try {
                            var rootPackage = "com.phoenixhell.app.page.";
    ...
    class PageHeader extends HBox {
        ...
        public PageHeader(Page page) {
            ...
            sourceCodeItem.setOnAction(
                    e -> DefaultEventBus.getInstance().publish(new PageEvent(PageEvent.Action.SOURCE_CODE_ON)));
