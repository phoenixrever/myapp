...
import static com.phoenixhell.app.ui.page.general.ColorPaletteBlock.validateColorName;
import static com.phoenixhell.app.util.ui.ContrastLevel.getColorLuminance;
import static com.phoenixhell.app.util.ui.ContrastLevel.getContrastRatioOpacityAware;
import static com.phoenixhell.app.util.ui.JColorUtils.flattenColor;
import static com.phoenixhell.app.util.ui.JColorUtils.toHexWithAlpha;
...
import com.phoenixhell.app.util.ui.ContrastLevel;
import com.phoenixhell.app.util.ui.JColor;
import com.phoenixhell.app.util.ui.JColorUtils;
import com.phoenixhell.app.util.ui.PlatformUtils;
...
final class ContrastChecker extends GridPane {
    ...
    private void createView() {
        ...
        bgSaturationLabel.textProperty().bind(Bindings.createStringBinding(
                () -> String.format("Saturation %.2f", bgSaturationSlider.getValue()),
                bgSaturationSlider.valueProperty()));
        ...
        bgLightnessLabel.textProperty().bind(Bindings.createStringBinding(
                () -> String.format("Lightness %.2f", bgLightnessSlider.getValue()),
                bgLightnessSlider.valueProperty()));
        ...
        fgSaturationLabel.textProperty().bind(Bindings.createStringBinding(
                () -> String.format("Saturation %.2f", fgSaturationSlider.getValue()),
                fgSaturationSlider.valueProperty()));
        ...
        fgLightnessLabel.textProperty().bind(Bindings.createStringBinding(
                () -> String.format("Lightness %.2f", fgLightnessSlider.getValue()),
                fgLightnessSlider.valueProperty()));
