...
import static com.phoenixhell.app.ui.page.general.ContrastChecker.LUMINANCE_THRESHOLD;
import static com.phoenixhell.app.ui.page.general.ContrastChecker.PASSED;
...
final class ColorPaletteBlock extends VBox {
    ...
    public Color getBgColor() {
        return colorRectangle.getBackground() != null && !colorRectangle.getBackground().isEmpty()
                ? (Color) colorRectangle.getBackground().getFills().get(0).getFill()
                : null;
    }
