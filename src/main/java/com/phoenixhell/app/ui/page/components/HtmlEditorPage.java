...
import com.phoenixhell.app.ui.page.AbstractPage;
import com.phoenixhell.app.ui.theme.HighlightJSTheme;
...
public final class HtmlEditorPage extends AbstractPage {
    ...
    private VBox editorSample() {
        ...
        fixToggle.selectedProperty().addListener((obs, old, val) -> {
            // toolbar icons can't be changed back without creating new editor instance
            // #javafx-bug
            try {
