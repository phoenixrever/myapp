...
// var snapshotKeys = new KeyCodeCombination(KeyCode.W,
...
// var transition = new
// FadeTransition(Duration.millis(PAGE_TRANSITION_DURATION),
// nextPage.getView());
...
// codeViewer.setContent(stream,
// tm.getMatchingSourceCodeHighlightTheme(tm.getTheme()));
