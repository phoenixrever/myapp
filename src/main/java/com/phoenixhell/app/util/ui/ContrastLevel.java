...
/**
 * The WCAG contrast measures the difference in brightness (luminance) between
 * two colours.
 * It ranges from 1:1 (white on white) to 21:1 (black on white). WCAG
 * requirements are:
 * <ul>
 * <li>0.14285 (7.0:1) for small text in AAA-level</li>
 * <li>0.22222 (4.5:1) for small text in AA-level, or large text in
 * AAA-level</li>
 * <li>0.33333 (3.0:1) for large text in AA-level</li>
 * </ul>
 * WCAG defines large text as text that is 18pt and larger, or 14pt and larger
 * if it is bold.
 * <br/>
